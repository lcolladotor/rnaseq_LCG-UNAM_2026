...
* Friday February 13:
  ...
  - 12-2 pm: differential expression analysis with `r BiocStyle::Biocpkg("limma")`
    ...
    - [2026 LIBD summer internship program](https://www.libd.org/summer-internship): application closes on February 20th.
...
You will also need to install [RStudio](https://rstudio.com/products/rstudio/download/#download) version RStudio 2026.01.0 or newer.
...
* Participation
  ...
  - (optional, strongly encouraged for your own career) Community building: CDSB Slack (introduce yourself), Bluesky, GitHub, etc. These are tracked by the TA: please let the TA know of your participations.
    ...
    - Bioconductor Zulip [#introductions](https://community-bioc.zulipchat.com/#narrow/channel/507510-introductions/topic//with/567532456) channel
