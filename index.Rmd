...
* [Slack CDSB Mexico](https://comunidadbioinfo.slack.com), in particular the [`intro_rnaseq_lcg_2026` channel](https://comunidadbioinfo.slack.com/archives/C0AC8U6UPD2). You can join this Slack workspace through [this link](https://join.slack.com/t/comunidadbioinfo/shared_invite/zt-8lsvpm84-Fne1W0hadk6cpjgJS17Tnw).
...
Install R 4.5.x from [CRAN](https://cran.r-project.org/) then install the following R packages:
...
You will also need to install [Positron](https://positron.posit.co/download.html).

Alternatively, you could install [RStudio](https://rstudio.com/products/rstudio/download/#download) version RStudio 2026.01.0 or newer.

In either case, you will also need to install [Air](https://posit-dev.github.io/air/) for automatic code formatting and get access to the [GitHub Education](https://github.com/education) pack.
