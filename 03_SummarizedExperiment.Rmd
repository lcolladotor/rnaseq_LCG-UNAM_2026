...
## Ejemplo con Hb_VTA_projector_profiling

Código del proyecto: [LieberInstitute/Hb_VTA_projector_profiling](https://github.com/LieberInstitute/Hb_VTA_projector_profiling)
Código del app de `r BiocStyle::Biocpkg("iSEE")`: [Hb_VTA_projection_profiling_iSEE](https://interactive.libd.org/Hb_VTA_projection_profiling/)
Presentación: [iSEE slides](https://speakerdeck.com/melii99/11022026-isee-hb-vta-lcg)
