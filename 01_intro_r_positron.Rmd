...
-   Material en el que estoy involucrado:
    ...
    -   <https://www.instagram.com/lcolladotor/>
...
-   Puedes tener páginas web estáticas
    ...
    -   <https://github.com/lcolladotor/rnaseq_LCG-UNAM_2026>. En especial <https://github.com/lcolladotor/rnaseq_LCG-UNAM_2026/tree/gh-pages> se convierte en <http://lcolladotor.github.io/rnaseq_LCG-UNAM_2026/>
...
## GitHub Education y el uso de IA para escribir código

* Es para obtener acceso gratuito a GitHub Pro y GitHub Copilot. En <https://github.com/education/students> vienen los detalles y los pasos a seguir.
* Hagan su cuenta de GitHub usando su email de la LCG-UNAM (tiene que ser un email de una institución académica). Así podrán completar la solicitud para el GitHub Education pack vía <https://education.github.com/discount_requests/application>.
  * Es posible que necesiten una carta en inglés por parte de la administración de la LCG con las fechas de cuando empezaron la LCG y cuando se estima que se graduarán. 
* Una vez que GitHub se los autorice podrán configurar su Positron para usar GitHub Copilot siguiendo las instrucciones de <https://positron.posit.co/assistant-getting-started.html>. 
  - Para RStudio sigan los siguientes pasos: <https://docs.posit.co/ide/user/ide/guide/tools/copilot.html>. Estos son los settings que uso en mi RStudio:

<img src="images/GitHub_Copilot_RStudio_config.png" width="500px" />

* Una vez que tengan GitHub Copilot configurado en Positron o RStudio, podrán usar <https://cran.r-project.org/package=chattr> para usar GitHub Copilot vía `chattr::chattr_app()`.
...
* Alternativamente, pueden usar <https://gemini.google.com/> u otros sitios web como <https://copilot.microsoft.com/>.
...
* <https://simonpcouch.github.io/chores/> puede ayudar con unas tareas específicas de programación que son repetitivas pero a la vez más complicadas de lograr vía prompts

```{r chores_demo, eval = FALSE}
## Instalar chores
...
* Más sobre IA y Posit (antes RStudio)
...
- Positron es gratis y lo podemos descargar desde <https://positron.posit.co/download.html>.
- Es una versión más moderna que RStudio y más compatible con Python, no solo con R.
- Está basado en [VS Code](https://code.visualstudio.com/), que es otro IDE.
...
-   RStudio projects (archivos `.Rproj`): usalos para organizar tu código
    -   <https://github.com/ComunidadBioInfo/cdsb2020/blob/master/presentaciones_flujos-de-trabajo/Trabajando-con-proyectos.pdf>
    -   El concepto de `.Rproj` ya no existe con Positron, aunque hay ciertas funciones equivalentes <https://positron.posit.co/migrate-rstudio-rproj.html>.
...
Después guarden su token de GitHub usando la siguiente sintaxis (ojo con la línea en blanco al final, las mayúsculas al inicio, y el que no hay espacios antes y después del `=`).
...
Resultado ejemplo: <https://github.com/lcolladotor/rnaseq_2021_notas>. El que hice en vivo está disponible vía <https://github.com/lcolladotor/rnaseq_2026_notas_en_vivo>.

Una vez que termines, agrega la liga al repositorio con tus notas del curso en [la página del curso](https://cursos.lcg.unam.mx/mod/url/view.php?id=9877).

## Material del curso

-   Pueden descargar la versión estática con `usethis::use_course('lcolladotor/rnaseq_LCG-UNAM_2026')`
-   Pueden verlo en línea a través de [**lcolladotor.github.io/rnaseq_LCG-UNAM_2026**](http://lcolladotor.github.io/rnaseq_LCG-UNAM_2026)
...
Notas de 30/01/2024 hechas por [Melissa Mayén Quiroz](https://melii99.github.io/).

<iframe class="speakerdeck-iframe" frameborder="0" src="https://speakerdeck.com/player/c05dfb09b94244e8a9dbef38fe258b7d" title="actividad_postcards.pdf" allowfullscreen="true" style="border: 0px; background: padding-box padding-box rgba(0, 0, 0, 0.1); margin: 0px; padding: 0px; border-radius: 6px; box-shadow: rgba(0, 0, 0, 0.2) 0px 5px 40px; width: 100%; height: auto; aspect-ratio: 560 / 315;" data-ratio="1.7777777777777777">
...
-   Tu página web debe decir algo sobre ti, tus intereses, y tus proyectos además de cómo contactarte
    ...
    -   <https://daianna-glez.github.io/> vía <https://github.com/daianna-glez/daianna-glez.github.io>.
...
-   Ahora deberán editar el documento R Markdown con su información y reemplazar la imagen con la que elijan :)
...
Siéntanse libres de compartir su página con el mundo. Si usan Bluesky, usen el hashtag #postcards y etiqueten al autor Sean Kross <https://bsky.app/profile/seankross.com>.
